...
HD_PWD='D:/nils/dev/vhdl/addierer/bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Bit_Adder_Arch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Four_Bit_Adder_Arch.tcl -notrace
